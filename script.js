...
// Add scroll reveal effect with stagger
...
// Skill tags hover effect - add ripple
...
// Add dynamic gradient to hero based on mouse position
const hero = document.querySelector('.hero');
if (hero) {
    hero.addEventListener('mousemove', (e) => {
        ...
        hero.style.background = `
            radial-gradient(circle at ${x * 100}% ${y * 100}%, rgba(99, 102, 241, 0.15) 0%, transparent 50%),
...
console.log('%c👋 Hi there! Thanks for checking out my portfolio!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
